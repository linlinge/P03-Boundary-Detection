...
void EvalAndEvec::MajorMinor(pcl::PointCloud<PointType>::Ptr cloud)
{
	...
	// major and minor
	major_val_=eig_val(2);
	minor_val_=eig_val(0);
	...
	minor_vec_<<eig_vec(0,0),eig_vec(1,0),eig_vec(2,0);
